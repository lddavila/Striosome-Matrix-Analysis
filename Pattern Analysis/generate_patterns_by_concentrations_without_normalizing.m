...
%             close all
    ...
    fileSaveName = strcat("All",namesOfDatabases(currentDB),"MapsByTaskTypeAndConcentrationsNotNormalized");
    save(fileSaveName,"allMaps")

    trialCountsFileName = strcat("All",namesOfDatabases(currentDB),"TrialCountsByTaskTypeAndConcentrationNotNormalized");
