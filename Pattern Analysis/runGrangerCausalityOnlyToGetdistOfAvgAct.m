function [foundOne,pairedCountCurr,array_of_firsts,neuron_1_z_score,neuron_2_z_score] = runGrangerCausalityOnlyToGetdistOfAvgAct(currentPair,currentDatabase,currentDatabasePairs,nlags,currentDB,dbs)
