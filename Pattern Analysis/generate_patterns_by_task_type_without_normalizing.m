...
%         ylim([0,5.5])
    ...
    fileSaveName = strcat("All",namesOfDatabases(currentDB),"MapsByTaskTypeNotNormalized");
    save(fileSaveName,"allMaps")

    trialCountsFileName = strcat("All",namesOfDatabases(currentDB),"TrialCountsByTaskTypeNotNormalized");
