function [foundOne,pairedLongTrialCounter,pairedShortTrialCounter,pairedWeirdlyLongTrialCounter,...
    ...
    pairedOrUnpaired,unpairedCountCurr,pairedCountCurr,...
    array_exc_strio_patt_times,array_inh_strio_patt_times,array_exc_mat_patt_times,array_inh_mat_patt_times] = gcModified4_create_hist_of_strio_mat_act_when_pat_is_det(currentPair,currentDatabase,currentDatabasePairs,nlags,currentDB,dbs)
...
if (strcmpi(summary.Decision(1),"Reject H0"))
    ...
    unpairedLongTrialCounter,unpairedShortTrialCounter,unpairedWeirdlyLongTrialCounter,...
    unpairedCountCurr,pairedCountCurr,array_exc_strio_patt_times,array_inh_strio_patt_times,array_exc_mat_patt_times,array_inh_mat_patt_times] = plotBinsModified4_cre_hist_f_str_mat_act_when_pat_is_det(neuron_2_spikes,neuron_1_spikes,neuron_2_timings,neuron_1_timings,dbs,currentDB,currentPair,neuron_2_index,neuron_1_index,pairedOrUnpaired);
    foundOne = 1;
else
    pairedOrUnpaired = 0;
    [pairedLongTrialCounter,pairedShortTrialCounter,pairedWeirdlyLongTrialCounter,...
