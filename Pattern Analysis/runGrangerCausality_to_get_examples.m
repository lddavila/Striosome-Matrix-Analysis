function [foundOne,pairedLongTrialCounter,pairedShortTrialCounter,pairedWeirdlyLongTrialCounter,...
    ...
    pairedOrUnpaired,unpairedCountCurr,pairedCountCurr,array_of_firsts] = runGrangerCausality_to_get_examples(currentPair,currentDatabase,currentDatabasePairs,nlags,currentDB,dbs)
...
if (strcmpi(summary.Decision(1),"Reject H0"))
    ...
    unpairedLongTrialCounter,unpairedShortTrialCounter,unpairedWeirdlyLongTrialCounter,...
    unpairedCountCurr,pairedCountCurr,array_of_firsts] = plotBins_modified_to_plot(neuron_2_spikes,neuron_1_spikes,neuron_2_timings,neuron_1_timings,dbs,currentDB,currentPair,neuron_2_index,neuron_1_index,pairedOrUnpaired);
    foundOne = 1;
else
    pairedOrUnpaired = 0;
    [pairedLongTrialCounter,pairedShortTrialCounter,pairedWeirdlyLongTrialCounter,...
